  ...
  return (
    ...
    >
      ...
      <p className="text-base text-left md:text-center text-gray-600 leading-relaxed mt-4 px-4">
        ...
        arcu. Etiam ut velit sed velit vestibulum lobortis a ac lorem. In congue
        finibus sem a egestas. Sed pellentesque arcu quis tristique viverra.
        Duis lacus sem, malesuada vel porttitor vestibulum, convallis eget
        tellus. Etiam quis lorem in erat suscipit gravida sed mollis lorem.
        Etiam iaculis et lectus ut venenatis.
      </p>
    </div>
  );
};
